...
"""
based on https://arxiv.org/abs/1406.7444,
see our work https://github.com/cgtuebingen/learning-blind-motion-deblurring
"""
...
class PSF(object):
    ...
    def cov_materniso(x, z, hyp=np.log([0.3, 1 / 4.]), d=3, i=None):
        ...
        based on code by Carl Edward Rasmussen and Hannes Nickisch, 2010-09-10 (COVFUNCTIONS.M).
        """
        ell = np.exp(hyp[0])
        sf2 = np.exp(2. * hyp[1])
