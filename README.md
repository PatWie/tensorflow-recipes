...
- **[FlowNet2-S](./OpticalFlow)** (Ilg et al., CVPR 2017) [[pdf]](https://arxiv.org/abs/1612.01925) [[ported caffe model]](http://files.patwie.com/recipes/models/weights.npz)
*FlowNet 2.0: Evolution of Optical Flow Estimation with Deep Networks*
    + just the inference part of FlowNet2-S
